create table tb_order (id int8 generated by default as identity, address varchar(255), latitude float8 not null, longitude float8 not null, moment timestamp, status int4, primary key (id));
